   ...
   */
    ...
    */
    void init() override; /**<   virtual init to heredate the variables */
	  ...
	  */
    void init(const char* data,const char* font_src, int size);

	  void init(const char* data,const char* font_src, int size, sf::Vector2f position, float rotation, sf::Vector2f scale, uint8_t border_color[4], uint8_t fill_color[4]);
